...
<body class="uk-text-center">
    ...
    <form class="uk-margin-auto uk-margin-large-top uk-form-stacked uk-width-1-3@m" method="POST" action="#">
        ...
        <div class="uk-margin">
            ...
            <div class="uk-form-controls">
                <input class="uk-input" id="form-stacked-text" type="text" name="nouveauNom"
                    placeholder="Remplire si modification du nom">
            </div>
        </div>
        <input type="submit" name="Supprimer" value="Supprimer" id="Supprimer"
            class="uk-button uk-button-primary uk-margin-small-top uk-margin-bottom"></input>
    ...
    <form action="#" method="post" class="uk-margin-auto uk-margin-large-top uk-form-stacked uk-width-1-3@m">
        ...
        <input type="submit" name="creerCategorie" value="Valider"
            class="uk-button uk-button-primary uk-margin-small-top uk-margin-bottom"
            onclick="UIkit.notification({message: 'Ajout réussi.', status: 'success'})"></input>
